...
function card(): RitualSingleTargetChatCardV2 { return { schemaVersion: 2, kind: "ritual", renderer: "single-target", revision: 0, createdAt: 1, messageId: "m", state: { schemaVersion: 1, castId: "c", renderer: "single-target", source: { id: "a", uuid: null, name: "A" }, item: { id: "i", uuid: null, name: "I" }, form: { id: "base", label: "Padrão" }, descriptionHtml: null, cost: null, target: { id: "t", uuid: null, name: "T", tokenId: null, tokenUuid: null }, conjuration: null, mainRoll: null, resistance: null, actions: [], createdAt: 1 }, legacyFallback: { summaryLines: [], itemName: "I", actorId: "a", itemId: "i" } }; }
