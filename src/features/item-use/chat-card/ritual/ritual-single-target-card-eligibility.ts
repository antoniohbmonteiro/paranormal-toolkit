...
export type RitualCardIneligibilityReason = "mode-legacy" | "unsupported-system" | "not-ritual" | "area-targeting" | "no-target" | "multiple-targets" | "missing-source" | "missing-item" | "missing-target-actor" | "unsupported-roll-intent" | "unsupported-action" | "missing-resistance-difficulty";
