...
.${PROMPT_CLASS}__resistance-workflow-roll .${PROMPT_CLASS}__workflow-roll-total {
  display: inline-flex;
  min-height: 1.78rem;
  align-items: center;
  justify-content: center;
  box-sizing: border-box;
  border: 1px solid rgba(79, 55, 42, 0.16);
  border-radius: 8px;
...
.${PROMPT_CLASS}__resistance-workflow-roll--succeeded .${PROMPT_CLASS}__workflow-roll-total {
  border-color: rgba(34, 116, 70, 0.34);
  background: rgba(52, 168, 83, 0.12);
  color: #1f6f43;
}

.${PROMPT_CLASS}__resistance-workflow-roll--failed .${PROMPT_CLASS}__workflow-roll-total {
...
.${PROMPT_CLASS}__roll-card--structured > .${PROMPT_CLASS}__workflow-section,
.${PROMPT_CLASS}__roll-card--structured > .${PROMPT_CLASS}__workflow-section--effect-action {
  margin-top: 0 !important;
  margin-bottom: 0 !important;
}
...
.${PROMPT_CLASS}__workflow-section--effect-action > .${PROMPT_CLASS}__workflow-section-header {
  grid-area: header;
  min-width: 0;
  margin: 0 !important;
}

.${PROMPT_CLASS}__workflow-section--effect-action > .${PROMPT_CLASS}__workflow-section-header strong {
  color: rgba(107, 78, 35, 0.95) !important;
  font-family: inherit !important;
  font-size: 0.74rem !important;
  font-style: normal !important;
...
.${PROMPT_CLASS}__effect-section-body {
  display: contents !important;
}

.${PROMPT_CLASS}__effect-section-label {
  grid-area: label;
  min-width: 0;
  color: rgba(36, 27, 24, 0.9);
  font-family: inherit !important;
...
.${PROMPT_CLASS}__effect-section-action {
  grid-area: button;
  display: inline-flex !important;
  align-items: center !important;
...
.${PROMPT_CLASS}__workflow-section--effect-action .${PROMPT_CLASS}__button {
  display: inline-flex !important;
  align-items: center !important;
  justify-content: center !important;
  width: auto !important;
...
.${PROMPT_CLASS}__workflow-section--effect-action .${PROMPT_CLASS}__button:hover,
.${PROMPT_CLASS}__workflow-section--effect-action .${PROMPT_CLASS}__button:focus {
  border-color: rgba(123, 72, 73, 0.62) !important;
  background: rgba(220, 199, 194, 0.86) !important;
  box-shadow: 0 0 0 2px rgba(151, 111, 45, 0.14) !important;
  outline: none !important;
...
.${PROMPT_CLASS}__workflow-section--effect-action .${PROMPT_CLASS}__button--executed,
.${PROMPT_CLASS}__workflow-section--effect-action .${PROMPT_CLASS}__button--effect-resolution-applied {
  min-width: 5.15rem !important;
  max-width: 6.25rem !important;
  border-color: rgba(96, 75, 45, 0.32) !important;
  background: rgba(236, 226, 210, 0.76) !important;
...
.${PROMPT_CLASS}__workflow-section--effect-action .${PROMPT_CLASS}__button--effect-resolution-waiting,
.${PROMPT_CLASS}__workflow-section--effect-action .${PROMPT_CLASS}__button--effect-resolution-resisted {
  min-width: 5.15rem !important;
  max-width: 6.75rem !important;
  border-color: rgba(96, 75, 45, 0.28) !important;
  background: rgba(239, 230, 216, 0.72) !important;
...
.${PROMPT_CLASS}__workflow-section--effect-action .${PROMPT_CLASS}__button--effect-resolution-waiting:hover,
.${PROMPT_CLASS}__workflow-section--effect-action .${PROMPT_CLASS}__button--effect-resolution-waiting:focus,
.${PROMPT_CLASS}__workflow-section--effect-action .${PROMPT_CLASS}__button--effect-resolution-waiting:disabled,
.${PROMPT_CLASS}__workflow-section--effect-action .${PROMPT_CLASS}__button--effect-resolution-resisted:hover,
.${PROMPT_CLASS}__workflow-section--effect-action .${PROMPT_CLASS}__button--effect-resolution-resisted:focus,
.${PROMPT_CLASS}__workflow-section--effect-action .${PROMPT_CLASS}__button--effect-resolution-resisted:disabled {
  border-color: rgba(96, 75, 45, 0.28) !important;
  background: rgba(239, 230, 216, 0.72) !important;
  box-shadow: none !important;
  outline: none !important;
...
.${PROMPT_CLASS}__target-row:focus-visible {
...
.${PROMPT_CLASS}__target-row[aria-expanded="true"] .${PROMPT_CLASS}__target-summary-actions {
  display: none !important;
}
...
.${PROMPT_CLASS}__target-details-actions .${PROMPT_CLASS}__target-action-label {
